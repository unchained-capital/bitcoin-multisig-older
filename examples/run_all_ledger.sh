...
pubkey1=$(export_ledger_pubkey $path1)
pubkey2=$(export_ledger_pubkey $path2)
pubkey3=$(export_ledger_pubkey $path3)
...
redeemscript=$(generate_multisig_redeem_script $pubkey1 $pubkey2 $pubkey3)
...
multisigaddress=$(generate_multisig_address $redeemscript --testnet)
